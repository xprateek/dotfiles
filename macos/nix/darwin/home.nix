...

{
  ...
  # Manage fish config file
  home.file."config/fish/config.fish".text = ''
    # Paste contents of your config.fish.backup here
    ...
    # PATH setup: Homebrew, GNU coreutils, Nix, custom, and system
    ...
    # Colorize man pages for readability
    ...
    # Enable autosuggestions and use custom color
    set -g fish_autosuggestion_enabled 1
    set -g fish_color_autosuggestion "555555"

    # Quick fish config reload function
    function reload
    ...
    # Toggle Git branch display in prompt (optional)
